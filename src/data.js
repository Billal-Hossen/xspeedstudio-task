...
import { COMPONENT, ROW, COLUMN } from "./components/share/constants";
...
const Data = {
  ...
  components: {
    ...
    component5: { id: "component4", type: "row", content: "Some row" },
    component6: { id: "component4", type: "column", content: "Some column" },
  }
};
